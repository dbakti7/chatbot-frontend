...
var dialogflowQueryURL = constants.LOCALHOST + ":" + constants.LOCALHOST_PORT + constants.DIALOGFLOW_QUERY_ENDPOINT;
if (constants.IS_PRODUCTION) {
  ...
  dialogflowQueryURL = constants.DEPLOYMENT_URL + constants.DIALOGFLOW_QUERY_ENDPOINT;
}
